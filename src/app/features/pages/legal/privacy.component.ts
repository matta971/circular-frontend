...
export class PrivacyComponent {
  crossLinks = [
    { icon: 'gavel', title: 'Mentions légales', description: 'Informations légales sur le site.', route: '/legal/terms' },
    { icon: 'shield', title: 'Sécurité des données', description: 'Nos mesures techniques de protection.', route: '/trust/data-security' },
    { icon: 'mail', title: 'Contact', description: 'Exercez vos droits ou posez vos questions.', route: '/contact' }
  ];
}

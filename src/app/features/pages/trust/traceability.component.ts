...
export class TraceabilityComponent {
  crossLinks = [
    { icon: 'science', title: 'M\u00e9thodologie', description: 'Notre approche d\'\u00e9valuation transparente et reproductible.', route: '/trust/methodology' },
    { icon: 'gavel', title: 'Conformit\u00e9 REP', description: 'Comprendre et respecter la r\u00e9glementation DEEE.', route: '/trust/rep-compliance' },
    { icon: 'person', title: 'Citoyens', description: 'Donnez une seconde vie \u00e0 vos appareils.', route: '/citoyen' }
  ];
}

...
export class PartnerDetailComponent implements OnInit {
  ...
  getScopeLabel(scope: DataScope | string): string {
    const labels: Record<string, string> = {
      'REP_COMPLIANCE': 'Conformité REP',
      'TRACEABILITY': 'Traçabilité',
      'DEVICE_FLOWS': 'Flux appareils',
      'CO2_IMPACT': 'Impact CO2',
      'TERRITORIAL_IMPACT': 'Impact territorial',
      'MATERIAL_RECOVERY': 'Récupération matériaux',
      'REUSE_RATES': 'Taux de réemploi',
      'COLLECTION_VOLUMES': 'Volumes collectés',
      'MARKET_PRICES': 'Prix du marché',
      'MARKET_TRENDS': 'Tendances marché',
      'REPAIRABILITY': 'Réparabilité',
      'METAL_PRICES': 'Prix métaux',
      'DEVICE_CONDITIONS': 'États appareils',
      'REPAIR_COSTS': 'Coûts réparation',
      'WARRANTY_DATA': 'Données garantie',
